...
class Celula{
    ...
    public Celula(Musica m, Celula esq, Celula dir) {
		this.musica = m.clone();
		this.esq = esq;
		this.dir = dir;
	}
...
class Arvore{
    ...
    public boolean pesquisar(String id){
        boolean resp = false;
        pesquisar(id, raiz, resp);
        return resp;        
    }
    private void pesquisar(String id, Celula i, boolean resp){
        if(i != null){
            pesquisar(id, i.esq, resp);
            if(id != i.musica.getId()){
                resp = true;
            }
            pesquisar(id, i.dir, resp);
        }
    }
	...
	private void caminharPre(Celula i){
		if(i != null){
            i.musica.imprimir();
			System.out.print("\n");
			caminharPre(i.esq);
	...
	private void caminharPos(Celula i){
		if(i != null){
			caminharPos(i.esq);
			caminharPos(i.dir);
            i.musica.imprimir();
    ...
    private Celula inserir(Musica m, Celula i)throws Exception{
